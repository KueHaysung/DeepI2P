...
if __name__ == '__main__':
    # input_root_path = '/media/qhc/Ubuntu 22.0/mykitti/data_odometry_velodyne/sequences'
    # output_root_path = '/media/qhc/Ubuntu 22.0/kitti/data_odometry_velodyne/sequences'
    input_root_path = '/media/qhc/Ubuntu 22.0/kitti/data_odometry_velodyne/dataset/sequences'
    output_root_path = '/media/qhc/Ubuntu 22.0/mykitti/data_odometry_velodyne//sequences'
